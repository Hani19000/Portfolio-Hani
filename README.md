...
# 🚀 Portfolio Full-Stack - Hani Derrouiche
...
- [⏱️ Timeline](#️-timeline-du-projet)
...
- ✔️ Validation et sanitisation des données (validator.js)
- 🛡️ Rate limiting anti-spam (2 messages/heure)
...
![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=for-the-badge&logo=typescript&logoColor=white)
![SendGrid](https://img.shields.io/badge/SendGrid-3368E8?style=for-the-badge&logo=sendgrid&logoColor=white)
![Sentry](https://img.shields.io/badge/Sentry-362D59?style=for-the-badge&logo=sentry&logoColor=white)
...
<details>
<summary><b>🔷 Pourquoi React + TypeScript ?</b></summary>
...
<details>
<summary><b>🔷 Pourquoi Vite ?</b></summary>
...
<details>
<summary><b>🔷 Pourquoi pas de framework CSS ?</b></summary>
...
<details>
<summary><b>🔷 Pourquoi SendGrid ?</b></summary>
...
<details>
<summary><b>🔷 Pourquoi le rate limiting ?</b></summary>
...
- ✔️ Validation côté frontend ET backend
...
- ⏱️ Rate limiting (2 requêtes/heure par IP)
...
- 👁️ Sentry configuré en frontend et backend
...
- 📋 Interfaces définies pour toutes les structures
- 🏷️ Props typées pour tous les composants
- 🚫 Aucun `any` (sauf gestion d'erreurs génériques)

### 📁 Organisation

- 🗂️ Structure de dossiers claire et cohérente
- 🔀 Séparation frontend/backend nette
- ⚙️ Configuration centralisée (`.env`, `tsconfig`, `vite.config`)
...
- 🏗️ **Backend robuste** : Passer sur NestJS ou Fastify pour une meilleure structure
- 💾 **Database** : Stocker les messages de contact dans une base de données
- 🎛️ **Admin panel** : Interface pour gérer les contenus sans toucher au code
...
- 🛠️ Choisi la stack : React + TypeScript + Express + SendGrid
...
- 🏗️ Comment structurer un portfolio efficace
...
- 🏗️ Défini l'architecture frontend/backend
- 📋 Modélisé les données (interfaces TypeScript)
- 📂 Créé la structure de dossiers
- ⚙️ Configuré les outils (ESLint, Prettier, TypeScript)
...
- 🏛️ L'architecture d'un projet full-stack moderne
...
- ⏱️ Implémenter un rate limiting fiable
...
- ⚙️ Gérer les variables d'environnement entre dev et production
...
- ⚛️ Maîtrise de React moderne (hooks, lazy loading, suspense)
...
- ☁️ Déploiement sur des plateformes cloud modernes (Vercel, Render)
...
### 🏗️ Capacité à structurer un projet de A à Z
...
![SendGrid](https://img.shields.io/badge/SendGrid-Account-3368E8?style=flat-square&logo=sendgrid&logoColor=white)
![Sentry](https://img.shields.io/badge/Sentry-Account-362D59?style=flat-square&logo=sentry&logoColor=white)
